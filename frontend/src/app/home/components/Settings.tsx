...
const Settings: FC = () => {
    return (
        <div className='text-black mr-8 hover:cursor-pointer flex justify-evenly relative group text-2xl'>
            ...
            <div className='flex flex-col justify-around items-center absolute top-10 bg-gray-100 text-center w-40 opacity-0 group-hover:opacity-100 group-hover:shadow-md'>
